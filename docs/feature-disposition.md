...
| `sidepulse serve` control/observability API | 4 | Keep | The loopback schema-v2 API remains a privacy-redacted surface for Stream Deck and scripts. It is useful even without first-party orchestration. |
