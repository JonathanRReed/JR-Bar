...
/// A stored Radar report's summary row (`list_radar_reports`).
public struct CoreRadarSummary: Codable, Hashable, Sendable, Identifiable {
    public var id: String
    ...
    enum CodingKeys: String, CodingKey {
        case id, analyzer, repository, revision, scope, nodes, edges
...
/// One normalized Radar graph node: `{id, name, kind}` with kind
/// bucketed to agent/tool/service/artifact/model/other.
public struct CoreRadarNode: Codable, Hashable, Sendable, Identifiable {
    public var id: String
    public var name: String?
    public var kind: String?
...
/// One normalized edge. `evidence` is always `"static"` on imported
/// reports — statically detected, never an observed call (T38).
public struct CoreRadarEdge: Codable, Hashable, Sendable {
    ...
    public init(source: String, target: String, kind: String? = nil,
                evidence: String? = nil, dangling: Bool? = nil) {
        self.source = source
        self.target = target
        self.kind = kind
...
/// A stored `radar_report` document: `{id, meta, nodes, edges}`.
public struct CoreRadarReport: Codable, Hashable, Sendable, Identifiable {
    public var id: String
    public var repository: String?
    public var revision: String?
    public var analyzerVersion: String?
    public var nodes: [CoreRadarNode]
    public var edges: [CoreRadarEdge]

    enum CodingKeys: String, CodingKey { case id, meta, nodes, edges }
    ...
    public init(from decoder: Decoder) throws {
        ...
        repository = try? meta?.decodeIfPresent(String.self, forKey: .repository)
        revision = try? meta?.decodeIfPresent(String.self, forKey: .revision)
        analyzerVersion = try? meta?.decodeIfPresent(String.self, forKey: .analyzerVersion)
        nodes = tolerantRows(
            CoreRadarNode.self,
            try c.decodeIfPresent([JSONValue].self, forKey: .nodes)
        )
        edges = tolerantRows(
            CoreRadarEdge.self,
            try c.decodeIfPresent([JSONValue].self, forKey: .edges)
        )
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try meta.encodeIfPresent(repository, forKey: .repository)
        try meta.encodeIfPresent(revision, forKey: .revision)
        try meta.encodeIfPresent(analyzerVersion, forKey: .analyzerVersion)
