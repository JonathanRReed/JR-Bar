...
def test_status_bar_has_no_codexbar_runtime_dependency__and_2_more() -> None:
    # --- scenario: status_bar_has_no_codexbar_runtime_dependency
    ...
    # --- scenario: only_t3_is_an_optional_external_agent_integration
    ...
    # --- scenario: codexbar_modules_are_absent
