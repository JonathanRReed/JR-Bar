...
def test_package_versions_match__and_2_more() -> None:
    # --- scenario: package_versions_match
    ...
    # --- scenario: fork_metadata_points_at_the_fork_and_preserves_upstream_link
    urls = _project()["urls"]
    ...
    # --- scenario: declared_pyobjc_frameworks_match_reachable_features
