...
def test_codex_windows_keep_five_hour_seven_day_and_additional_limits__and_2_more() -> None:
    # --- scenario: codex_windows_keep_five_hour_seven_day_and_additional_limits
    ...
    # --- scenario: non_seven_day_primary_is_never_called_weekly
    view = build_provider_usage_view(
        "codex",
        "Codex",
    ...
    # --- scenario: claude_known_and_additional_windows_keep_duration_and_reset_values
...
def test_malformed_percent_is_ignored_and_numeric_percent_is_clamped__and_2_more() -> None:
    # --- scenario: malformed_percent_is_ignored_and_numeric_percent_is_clamped
    view = build_provider_usage_view(
        "codex",
        "Codex",
        (
    ...
    # --- scenario: capacity_remaining_is_clamped_and_usage_knowledge_is_explicit
    view = build_provider_usage_view(
        "codex",
        "Codex",
        (
    ...
    # --- scenario: reset_metadata_without_usage_never_displays_a_fake_zero_percent
    view = build_provider_usage_view(
        "claude",
        "Claude",
        (
...
def test_malformed_reset_is_omitted_without_hiding_valid_usage__and_2_more() -> None:
    # --- scenario: malformed_reset_is_omitted_without_hiding_valid_usage
    view = build_provider_usage_view(
        "codex",
        "Codex",
        (
    ...
    # --- scenario: stale_last_known_good_data_remains_visible_with_provider_error
    view = build_provider_usage_view(
        "claude",
        "Claude",
    ...
    # --- scenario: stale_last_known_good_keeps_remaining_but_withholds_reset_authority
    view = build_provider_usage_view(
        "claude",
        "Claude",
        (
...
def test_missing_refreshing_fresh_and_error_states_are_distinct__and_2_more() -> None:
    # --- scenario: missing_refreshing_fresh_and_error_states_are_distinct
    ...
    # --- scenario: source_text_is_bounded_and_does_not_expose_absolute_paths
    view = build_provider_usage_view(
        "codex",
        "Codex",
        (),
    ...
    # --- scenario: successful_empty_result_clears_windows_without_becoming_missing
    view = build_provider_usage_view(
        "codex",
        "Codex",
        (),
...
def test_settings_text_keeps_local_summary_alongside_rate_windows__and_2_more() -> None:
    # --- scenario: settings_text_keeps_local_summary_alongside_rate_windows
    view = build_provider_usage_view(
        "codex",
        "Codex",
        ({"used_percent": 20, "window_minutes": 300},),
    ...
    # --- scenario: named_legacy_adapter_normalizes_used_first_once_and_preserves_null_zero
    ...
    # --- scenario: compact_capacity_copy_is_remaining_first_after_legacy_adaptation
...
def test_local_activity_and_cost_estimate_are_typed_sections_not_quota_lanes__and_2_more() -> None:
    # --- scenario: local_activity_and_cost_estimate_are_typed_sections_not_quota_lanes
    ...
    # --- scenario: claude_normalization_ignores_boolean_utilization_and_accepts_reset_alias
    windows = claude_quota.windows_from_payload(
        {
    ...
    # --- scenario: normalizers_skip_nonfinite_and_boolean_window_values_without_crashing
...
def test_claude_real_fable_limits_shape_keeps_only_scoped_weekly_extra__and_2_more() -> None:
    # --- scenario: claude_real_fable_limits_shape_keeps_only_scoped_weekly_extra
    payload = {
        "five_hour": {
            "utilization": 11.0,
    ...
    # --- scenario: claude_scoped_windows_precede_one_routines_alias_without_duplicates
    payload = {
        "five_hour": {
            "utilization": 12.5,
    ...
    # --- scenario: claude_top_level_model_weekly_aliases_preserve_duration_and_reset
