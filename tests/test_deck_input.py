...
def test_one_action_per_press_and_release_rearms_the_key__and_2_more() -> None:
    # --- scenario: one_action_per_press_and_release_rearms_the_key
    ...
    # --- scenario: keys_and_remapped_dial_inputs_keep_their_exact_logical_identity
    router = DeckInputRouter()
    ...
    # --- scenario: untrusted_input_cannot_select_a_command_or_target
    router = DeckInputRouter()
    for value in (
