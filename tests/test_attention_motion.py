...
def test_attention_arrival_is_explicit_finite_motion_over_a_static_base__and_2_more() -> None:
    # --- scenario: attention_arrival_is_explicit_finite_motion_over_a_static_base
    statuses = (
    ...
    # --- scenario: every_attention_render_path_settles_to_a_static_anchor
    for statuses, settings in [
        (
            (_status("claude", AgentMode.WAITING_FOR_INPUT),),
    ...
    # --- scenario: projection_attention_uses_the_same_finite_arrival_contract
...
def test_completion_style_cannot_append_an_unbounded_repeat__and_2_more() -> None:
    # --- scenario: completion_style_cannot_append_an_unbounded_repeat
    ...
    # --- scenario: failure_signal_honors_exact_repetitions_and_settles_at_deadline
    ...
    # --- scenario: failure_signal_one_and_two_repetition_programs_are_distinct
